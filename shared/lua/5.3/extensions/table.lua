...
function table.Copy( t, lookup_table )
	...
	local copy = {}
	--setmetatable( copy, debug.getmetatable( t ) ) -- This breaks fengari
...
function table.Add( dest, source )
	...
	if isArr then
		for k, v in ipairs( source ) do -- EDIT: Some issues with tables not being ordered correctly, fixed by making this ipairs
			table.insert( dest, v )
		end
	else
		for k, v in pairs( source ) do -- EDIT: Some issues with tables not being ordered correctly, fixed by making this ipairs
			table.insert( dest, v )
		end
	end
